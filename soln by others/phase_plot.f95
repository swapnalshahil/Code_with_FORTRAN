...
PROGRAM main
    ...
    a = 1.51
    dt = 0.1
    y(1) = 5! 1000.0*1000.0/a
    y(2) =  3!35800.0 * 1000.0
    y(3) =   0! 4.07 *1000.0 
    y(4) =   0.0
    yold=y
    do i=1,7200
        t =i
        call rk4(y,n,dt,t)
        if(y(2)*yold(2) .lt. 0)then
           write(8,*)y(1),y(3)
        endif
        yold=y
        write(outunit,*) t, y(1),y(2),y(3),y(4)
    end do
...
subroutine fn_for_rk(temp, f, n,dt,t)
    ...
    f(1) = temp(3)
    f(2) = temp(4)
    f(3) =  -temp(1)!-g*m* 1.0*temp(1) / ((temp(1)**2 + temp(2)**2)**(5.0/2))
    f(4) =  -temp(2)*0.7d0!-g*m*1.0*temp(2) / ((temp(1)**2 + temp(2)**2)**(5.0/2))
    dt = dt
    t = t
